      ...
      <Container>
        <Row>
          ...
          <Col xs={{size: 12, order: 3}} sm={{size: 12, order: 3}} md={{size: 6, order: 4}} lg={6}>
            ...
            <p className={styles.info__description}>В нашей игре каждый может создать собственный уровень! Нужно лишь зарегистрироваться и открыть редактор. После сохранения уровня, он пройдет модерацию и появится в общем доступе. Будьте уверены, проектирование новых уровней является не менее интересным, чем их прохождение.</p>
          ...
          <Col xs={{size: 12, order: 5}} sm={{size: 12, order: 5}} md={{size: 6, order: 5}} lg={6}>
            ...
            <p className={styles.info__description}>Сразу после регистрации Вам будет доступна таблица личных достижений и созданных уровней. Мы ведем статистику наиболее популярных уровней. Информация о самых посещаемых и популярных из них отражена в таблице достижений.</p>
