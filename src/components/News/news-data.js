const news = {
  ...
  "levels": [
    {id: 1, type: true, description: 'Вы оказались в загадочном лабиринте! Что делать? А вот хз!'},
    {id: 2, type: false, description: 'Вы оказались в загадочном лабиринте! Что делать? А вот хз!'},
    {id: 3, type: false, description: 'Вы оказались в загадочном лабиринте! Что делать? А вот хз!'},
    {id: 4, type: true, description: 'Вы оказались в загадочном лабиринте! Что делать? А вот хз!'},
    {id: 5, type: false, description: 'Вы оказались в загадочном лабиринте! Что делать? А вот хз!'},
    {id: 6, type: true, description: 'Вы оказались в загадочном лабиринте! Что делать? А вот хз!'}
  ]
}
